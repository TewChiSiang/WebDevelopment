...
import { FaUserGraduate , FaKey, FaArrowLeft, FaEye, FaEyeSlash } from 'react-icons/fa';
import { Inertia } from '@inertiajs/inertia';
import axios from 'axios';
import CustomNavbar from '../../components/CustomNavbar';

const LectureProfile = ({ auth }) => {
                    ...
                    <Card.Body className="tw-p-6">
                        <div className="tw-flex tw-justify-center tw-mb-6">
                            <div className="tw-bg-blue-100 tw-rounded-full tw-p-6">
                                <FaUserGraduate className="tw-w-16 tw-h-16 tw-text-blue-600" />
                            </div>
                        </div>
